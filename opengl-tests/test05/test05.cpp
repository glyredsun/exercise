...
void key_callback(GLFWwindow *window, int key, int keyscan, int action, int mods)
{
...
int main(void)
{
	...
	while (glfwWindowShouldClose(window) != GL_TRUE) {
		...
		glm::mat4 view = glm::lookAt(glm::vec3(0.0f, 0.0f, 4.0f), glm::vec3(), glm::vec3(0.0f, 1.0f, 0.0f));
		glm::mat4 model;
